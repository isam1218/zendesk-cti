                ...
                <div id="full">
                    ...
                    <div className="info">
                        ...
                        <div className="associateZendesk">
                            ...
                            <input id="associateTicket" type="text" placeholder="Ticket Number"
                                   value={this.state.ticketNumber}
                                   onChange={(e) => this._updateValue(e, 'ticketNumber')}/>
                        </div>

                        <i className="material-icons end"
                           onClick={() => this._endCall(mycall, this.state.ticketNumber)}>call_end</i>
